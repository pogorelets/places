const titleSignLightScreen = "Список\nинтересных мест";

//замоканные строки экрана детализации
const headDetail = "Пряности и радости";
const typeDetail = "ресторан";
const closed = "закрыто до 09:00";
